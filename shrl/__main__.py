...
parser.add_argument(
    "--with-metadata",
    help=(
        "Load Collaborator, Reference, and/or SourceStudy records from a "
...
load.add_argument(
    ...
    action="store_true",
    help=(
        "Initialize the database according to the SHARED schema (for "
...
load.add_argument(
    ...
    action="store_true",
    help=(
        "Insert Regimen and RegimenDrugInclusion records for the standard "
